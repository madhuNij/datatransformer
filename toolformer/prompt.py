...
# %% auto 0
__all__ = ['calculator_prompt', 'qa_prompt', 'wolframe_prompt']
...
Input: Out of 1400 participants, 400 (or 29%) passed the test. 
Output: Out of 1400 participants, 400 (or [Calculator(400 / 1400)] 29%) passed the test. 
